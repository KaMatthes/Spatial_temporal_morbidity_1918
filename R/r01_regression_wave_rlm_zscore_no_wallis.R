...
dt <- rbind(dt1,dt2, dt3) %>%
  rename( MapName =BEZNA,
          Bezirk  =BEZNR ) %>%
  filter(!Bezirk %in% c(1600,2301, 2302,2303, 2304, 2305, 2306, 2307, 2308, 2309,2310,2311,2312,2313))
...
write.xlsx( res_uni2 ,"output/Regression_rlm_zscore_no_wallis.xlsx", row.names=FALSE, overwrite = TRUE)
