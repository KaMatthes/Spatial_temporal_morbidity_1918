...
res_uni2 <- rbind(w1, w2, w3) %>%
  filter( Cofactor=="GDP_n" | Cofactor=="densPop_n" |   Cofactor=="LW_prop_n"| Cofactor=="Haushalte.pro.Haus"| Cofactor=="person.pro.Haushalt"| 
            Cofactor=="hospitals" | Cofactor=="tb_d_pop_n" |   Cofactor=="tb_i_pop_n" |  Cofactor=="docs_pop_n"  |  Cofactor=="docs_p_pop_n" |  Cofactor=="docs_s_pop_n"|
...
write.xlsx( res_uni2 ,"output/Regression_lm_zscore.xlsx", row.names=FALSE, overwrite = TRUE)
