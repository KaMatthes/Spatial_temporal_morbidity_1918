...
dt <- read.xlsx("data/Faelle_Bezirke_Conscrips.xlsx", detectDates = TRUE)
  
ggplot(dt) +
  geom_line(aes(y=Cases,x= Startdatum), lwd=lwd_size) +
...
ggsave("figures/Figure_inc_cons.png",h=10,w=18)
